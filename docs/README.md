...
- [`CHALLENGE_ARCHIVE_AND_CARDS.md`](CHALLENGE_ARCHIVE_AND_CARDS.md): verbindliche Semantik für öffentliche Challenge-Nummern, bestätigte Historie und Challenge-Card-Persistenz
