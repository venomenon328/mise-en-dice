...
Der unterstützte automatische Upgradehorizont besitzt zusätzlich die versionierte Testbaseline
[`db.changelog-production-baseline.yaml`](../src/test/resources/db/changelog/db.changelog-production-baseline.yaml).
Sie bildet den bestätigten Produktionsstand
`main@b6543868e60f57bfa53caa3b42d4a96a9ff25a77` exakt bis einschließlich
