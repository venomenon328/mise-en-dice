...
`challenge_participation` bleibt davon getrennt. Nach einer 11A-Bestätigung übernimmt 11B idempotent alle Electorate-Mitglieder; ein weiterer aktiver registrierter Teilnehmer kann später ebenfalls idempotent beitreten. Weder Snapshot noch Votes, Generatorhistorie oder Beschaffbarkeitsmatrix ändern sich dadurch.
