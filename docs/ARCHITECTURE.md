...
Phase 11B ergänzt danach ausschließlich einen transportneutralen Teilnehmer-, Electorate- und Voting-Core gemäß `CHALLENGE_VOTING_AND_PARTICIPATION.md`. Er verwendet die öffentlichen Offer-Decision-APIs aus 11A und führt weder Discord-Transport noch eine parallele Challenge-/Historienpersistenz ein. Erst Phase 11C wird ein dünner Discord-Adapter für Darstellung und Interaktion.
