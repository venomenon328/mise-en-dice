...
Produktvision, Datenmodell, Anwendungsfundament, umfangreicher initialer Zutatenkatalog, Administrationssicherheit, die konsolidierte Katalogoberfläche, die vollständige Zutatenpflege einschließlich Rollen, Eigenschaften, Beschaffbarkeit, Saison und direkter Konkretisierungsbeziehungen sowie das Produktions- und Branch-Preview-Deployment sind umgesetzt. Direkte Parent-/Child-Kanten werden gemeinsam mit Rollen und Spezifität gegen den resultierenden Graphen validiert; Mehrfach-Eltern bleiben erhalten. Als nächster fachlicher Schritt folgen Ausschlüsse, Bulk-Aktionen und die Auditansicht.
